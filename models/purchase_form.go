...
type PurchaseFormRequest struct {
	...
	HarusInden         bool   `json:"harus_inden" binding:"required"`
	LamaInden          string `json:"lama_inden" binding:"required"`
	CustomPlat         string `json:"custom_plat" binding:"required"`
	TambahanKit        string `json:"tambahan_kit" binding:"required"`
